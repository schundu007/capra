...
const CODING_PLATFORMS = {
  hackerrank: { name: 'HackerRank', icon: 'H', color: '#1ba94c', url: 'hackerrank.com' },
...
const PREP_PLATFORMS = {
  techprep: { name: 'TechPrep', icon: 'T', color: '#8b5cf6', url: 'techprep.app' },
  algomaster: { name: 'AlgoMaster', icon: 'A', color: '#14b8a6', url: 'algomaster.io' },
  neetcode: { name: 'NeetCode', icon: 'N', color: '#f43f5e', url: 'neetcode.io' },
