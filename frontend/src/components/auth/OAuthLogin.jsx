...
import ChunduLogo from '../ChunduLogo.jsx';

/**
 * OAuth Login Component - Google, GitHub, LinkedIn
 */
export default function OAuthLogin() {
  ...
  const handleOAuthLogin = async (provider) => {
    ...
    try {
      ...
      // Redirect happens automatically to cariara OAuth
    } catch (err) {
      ...
      <div className="relative w-full max-w-sm">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-white mb-2">Welcome to Ascend</h1>
          ...
          <div className="space-y-3">
            {providers.map((provider) => (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
