      ...
      <div className="flex-1 min-h-screen">
        ...
        <div className="sticky top-0 z-20 px-8 py-4 flex items-center justify-between" style={{ background: 'rgba(9, 9, 11, 0.9)', backdropFilter: 'blur(8px)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div className="flex items-center gap-4">
            <a href="/" className="px-4 py-2 rounded-lg text-sm font-medium text-blue-400 hover:bg-blue-400/10 transition-colors" style={{ border: '1px solid rgba(59, 130, 246, 0.3)' }}>
        ...
        <div className="px-8 py-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-12">
            {filteredTopics.map((topic) => (
              <a
                key={topic.id}
                href={`/docs/system-design/${topic.id}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
            {systemDesigns.map((design) => (
              <a
                key={design.id}
                href={`/docs/system-design/${design.id}`}
