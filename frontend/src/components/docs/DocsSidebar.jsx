...
export default function DocsSidebar({ activePage }) {
  ...
  return (
    <div className="w-64 flex-shrink-0 h-screen sticky top-0 flex flex-col" style={{ background: '#ffffff', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
      {/* Logo */}
      <div className="p-5">
        <a href="/app" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <span className="text-lg font-bold text-gray-900">Ascend</span>
        </a>
      </div>
